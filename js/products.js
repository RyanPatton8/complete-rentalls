...
"Augers": [
    ...
    },
    {
      ...
      "prices": [
        ...
        { "label": "4 Weeks", "amount": "1320.00" }
      ],
      "img": "./imgs/products/equipment/Augers/bhydauger.gif",
      "desc": `<ul>
          <li>Towable (2 inch ball required)</li>
    ...
    {
      "id": "67",
      "name": "Pressure Washer 2000 PSI (Gas)",
      "prices": [
        { "label": "4 hour", "amount": "55.00" },
        { "label": "1 Day",  "amount": "75.00"},
        { "label": "Weekend",  "amount": "112.50" },
        { "label": "1 Week", "amount": "300.00" },
        { "label": "4 Weeks", "amount": "750.00" }
      ],
      "img": "./imgs/products/equipment/cleaning/bwasher.jpg",
    },
        {
      "id": "14",
      "name": "Magnet Sweeper",
